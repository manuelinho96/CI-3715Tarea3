...
class Test(unittest.TestCase):
    ...
    #Caso interior cuando usuario registrado y aceptado al ingresar.
    ...
    #Caso esquina cuando usuario no registrado y intenta ingresar al sistema.
    def test_ingresousuarionoregistrado(self):
        self.prueba.diccionario = { }
        self.validar = self.prueba.IngresarUsuario("13-11223@usb.ve", "Manuel123")
        self.assertEqual(-4, self.validar[0])
    
    #Caso esquina cuando usuario registrado y intenta ingresar al sistema con clave invalida
    ...
    #Caso malicioso cuando un usuario intenta registrarse con un correo ya registrado
    def test_ingresousuarioyaregistrado(self):
        self.prueba.diccionario = { }
        self.registro = self.prueba.registrarUsuario("13-11223@usb.ve", "Manuel123","Manuel123")
        self.validar = self.prueba.registrarUsuario("13-11223@usb.ve", "Manuel123","Manuel123")
        self.assertEqual(-6, self.validar[0])
